  ...
  's31-2': [
    ...
    { id: 2, senderId: 31, text: 'Exporting Variant C / Empty State from the Northwind launch file at 2x…', time: '2:36 PM' },
    {
      ...
      link: {
        ...
        embedUrl: 'https://www.figma.com/embed?embed_host=teams&url=https://figma.com/file/nw-launch/variant-c-empty-state',
      },
      time: '2:38 PM',
    },
  ...
  's31-3': [
    { id: 1, senderId: 'me', text: 'What\'s the latest version of the prompt-suggestion card component?', time: '10:13 AM' },
    {
      ...
      link: {
        ...
        embedUrl: 'https://www.figma.com/embed?embed_host=teams&url=https://figma.com/file/nw-ui-lib/card-prompt-suggestion',
      },
      time: '10:13 AM',
    },
  ...
  's31-4': [
    { id: 1, senderId: 'me', text: 'Audit detached component instances across the Northwind launch file.', time: '11:18 AM' },
    {
      ...
      link: {
        ...
        embedUrl: 'https://www.figma.com/embed?embed_host=teams&url=https://figma.com/file/nw-launch',
      },
      time: '11:18 AM',
    },
  ...
  's31-6': [
    { id: 1, senderId: 'me', text: 'Compare the v2.3 and v2.4 component library — list breaking renames.', time: '9:30 AM' },
    {
      ...
      link: {
        ...
        embedUrl: 'https://www.figma.com/embed?embed_host=teams&url=https://figma.com/file/nw-ui-lib',
      },
      time: '9:30 AM',
    },
